                ...
                <Button
                    ...
                    on_click=move |_| {
                        ...
                        if !name_converted.is_empty() &&
                            ...
                            && params.read_untracked().headers.read_untracked().iter().find(|h|h.name.read_untracked().trim().to_lowercase() == name_converted).is_none() {
                ...
                view! {
                    <div class="flex gap-4 w-full">
                        ...
                        <Button
                            ...
                            disabled=move || false
                            on_click=move |_| {
                                params.read_untracked().set_headers.write().retain(|h| h.id != custom_header.id);
                            }
                        />
                    </div>
                }
