            ...
            <div class="px-1 py-2 sm:px-2 lg:px-4">
                <div class="flex justify-between">
                    ...
                    <div class="flex flex-row flex-wrap gap-2 md:gap-4">
                        ...
                        <ButtonLink class_name="hidden md:block".to_owned() label=move || t_display!(i18n, rest_client_btn_label).to_string() href="/rest_client".to_owned() button_width=ButtonLinkWidth::Auto
