...
pub fn ButtonLink(
    ...
    let base_classes = "rounded-3xl cursor-pointer font-medium px-6 py-1 md:py-2 h-8 md:h-10 justify-center items-center text-sm md:text-base transition-[background-color,border-color,box-shadow,color] duration-294".to_owned();
